...
Frontend Client для наглядной демонстрации взаимодействия с сервером:
===========================
...
Для этого можно отправить запрос http://localhost:8090/rest/voting/1/ui (перейти по сгенерированной ссылке + "/ui"").
